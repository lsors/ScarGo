...
#define SCARGO_FOOT_LATERAL_SPREAD_RATIO 0.9f

#define SCARGO_DEFAULT_STEP_HEIGHT_MM 40.0f
#define SCARGO_MIN_STEP_HEIGHT_MM 20.0f
#define SCARGO_MAX_STEP_HEIGHT_MM 80.0f

#define SCARGO_DEFAULT_STEP_CYCLE_MS 600
#define SCARGO_MIN_STEP_CYCLE_MS 350
...
#define SCARGO_MAX_BODY_YAW_DEG 15.0f
...
#define SCARGO_DIAG_BALANCE_KP_ROLL  0.30f
#define SCARGO_DIAG_BALANCE_KI_ROLL  0.01f
#define SCARGO_DIAG_BALANCE_KD_ROLL  0.05f
#define SCARGO_DIAG_BALANCE_KP_PITCH 0.30f
#define SCARGO_DIAG_BALANCE_KI_PITCH 0.01f
#define SCARGO_DIAG_BALANCE_KD_PITCH 0.05f
